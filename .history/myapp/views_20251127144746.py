...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    try:
        # 🎯 CRITICAL FIX: Use 'id' instead of '_id' in the .get() query.
        # This aligns with the FieldError traceback showing 'id' is a recognized choice.
        obj = Product.objects.get(id=object_id) # <--- CHANGED FROM _id=object_id
        return obj
    
    # Ensure you are still using the correct exception handling
    except Exception as e:
        # ... (Logging/error handling remains the same) ...
