...
from mongoengine.queryset.manager import DoesNotExist
class ProductViewSet(viewsets.ModelViewSet):
    ...
    try:
        obj = Product.objects.get(_id=object_id)
        return obj
    # CATCH BOTH POSSIBLE EXCEPTIONS
    except (Product.DoesNotExist, DoesNotExist): # <-- FIX IS HERE
