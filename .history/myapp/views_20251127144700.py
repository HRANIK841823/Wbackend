...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def get_object(self):
        ...
        # ⚠️ WARNING: DO NOT USE THIS IN PRODUCTION. Use only for debugging the 500 error.
        except Exception as e:
            # THIS WILL PRINT THE EXACT ERROR to your console 
            # and still cause a 500 but with the stack trace you need.
            print(f"!!! CRASH DEBUG !!!: {type(e).__name__}: {e}")
            raise e # Re-raise the original exception to see the traceback
